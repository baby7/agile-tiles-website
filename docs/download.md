...
<div class="download-container">
  ...
  <div class="version-info">
    ...
    <div class="version-number">V1.2.4</div>
    <div class="release-date">更新时间: 2025年8月30日</div>
  </div>
  ...
  <div class="download-card">
    ...
    <a href="https://server.agiletiles.com/update/setup/AgileTilesSetupV1.2.4.exe" class="download-button">
      下载安装包
    </a>
  </div>
