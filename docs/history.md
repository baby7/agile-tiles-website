...
#### 版本 v1.8.6 - 2025-10-28
- 修复点击系统加速球时闪退的问题

#### 版本 v1.8.5 - 2025-10-27
- 紧急修复：启动异常

#### 版本 v1.8.4 - 2025-10-27
- 卡片设计器适配高分辨率屏幕
- 卡片设计器支持增加高度，避免高分辨率下底部空白
- 面板顶部增加拖拽提示，可点击拖拽到其他屏幕，也可以在一个屏幕内移动到两侧设置界面和托盘区右键菜单部分内容调整
- 调整局域网文件传输功能的图标
- 增加QQ群反馈渠道展示
- 内存优化(持续优化中)

#### 版本 v1.8.3 - 2025-10-23
...
#### 版本 v1.8.1 - 2025-10-13
- 热搜刷新后滚动到顶部
- 待办事项列表默认进入为待办分类
- 待办事项列表每项增加编辑按钮
- 其他部分优化和修复

#### 版本 v1.8.0 - 2025-10-08
- 软件底层框架升级，需要进行强制更新
- 适配微软应用商店的前期准备
- 热搜可以鼠标中键点击多个热搜不隐藏面板
- 工具模块新增本机IP信息工具
...
#### 版本 v1.7.0 - 2025-10-01
- 程序启动时不再要求管理员权限
- 修复切换音乐播放时可能导致的界面卡死

#### 版本 v1.6.0 - 2025-09-27
- 未登录也可试用部分功能
- 调整选项卡的显示样式
- 调整热搜的显示样式
- 音乐功能调整背景样式
